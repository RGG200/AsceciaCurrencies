...
public final class AsceciaCurrencies extends JavaPlugin implements TabCompleter {
    ...
    public void onEnable() {
        String sVersion = Bukkit.getBukkitVersion().split("-")[0];switch (sVersion){
            case "1.21.11","1.21.10","1.21.9","1.21.8","1.21.7","1.21.6","1.21.5","1.21.4","1.21.3","1.21.2","1.21.1","1.21","1.20.6","1.20.5","1.20.4","1.20.3","1.20.2","1.20.1", "1.19", "1.19.2", "1.19.1", "1.18.2", "1.18.1", "1.18", "1.19.3", "1.19.4", "1.20","1.17.1","1.17":
        ...
        invites.scheduleSyncRepeatingTask(this, new Runnable() {
            ...
            public void run() {
                for(String player: PlayersConfig.get().getKeys(false)){
                    if(PlayersConfig.get().contains(player + ".invite")){
                    ...
                    if(PlayersConfig.get().contains(player + ".convertrequests")){
                        PlayersConfig.get().set(player + ".convertrequests", null);
                    }
                }
            }
        }, 0L, 20L*300);
