...
public class CurrenciesAPI{
    ...
    public static boolean CurrencyAdd(Player p, String name, double amount){
        if(p != null){
    ...
    public static boolean CurrencyCreate(Player p, String name){
        //getting player id
        int count = 0;
    ...
    public static boolean CurrencyDelete(Player p, String name){
    ...
    public static boolean CurrencyForceDelete(String name){
        String cname = name;
    ...
    public static boolean CurrencyInfo(Player p, String name){
        if (!name.equals(null)) {
            if (CustomConfig.get().contains(name)) {
    ...
    public static boolean CurrencyList(Player p){
        //displays currencies
    ...
    public static boolean CurrencyMint(Player p, String stramount){
    ...
    public static boolean CurrencyDeposit(Player p, double itemamount){
        //init root variable
        String id = p.getUniqueId().toString();
        Boolean hasCreated = PlayersConfig.get().getBoolean(id + ".hascreated");
    ...
    public static boolean CurrencyPay(Player p,Player target, String name, String stramount){
    ...
    public static boolean CurrencyRemove(Player p, String name, double amount){
        if(p != null){
            if (CustomConfig.get().contains(name)) {
                if (amount > 0) {
                    String id = p.getUniqueId().toString();
    ...
    public static boolean CurrencyWithdraw(Player p, String name, String stramount){
    ...
    public static boolean CurrencyWallet(Player p){
