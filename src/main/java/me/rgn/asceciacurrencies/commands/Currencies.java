        ...
        if (args[0].equals("force") && args[1].equals("delete")){
            if (sender instanceof Player) {
                ...
                if (p.hasPermission("asceciacurrencies.admin")) {
                    if (args.length > 3) {
                        p.sendMessage(ChatColor.DARK_RED + "[Currencies]: /currencies force delete (currencyname)");
                    } else {
        ...
        if (sender instanceof Player) {
            ...
            if (p.hasPermission("asceciacurrencies.players")) {
                ...
                //description
                     ...
                     if (args.length < 2  || args.length > 2) {
                         p.sendMessage(ChatColor.DARK_RED + "[Currencies]: /currencies description (description)");
                     } else {
                         CurrenciesAPI.Currencies.description(p, args[1]);
                     }
                 }
                //withdraw
